...
namespace Triheroes.Code
{
    public class way_to_target_navi : waypointer2d
    {
        ...
        IEnumerator LowUpdate ()
        {
            ...
            while (true)
            {
                ...
                if (NavMesh.CalculatePath ( md.position, ma.target.md.position, NavMesh.AllAreas, path ))
    ...
    public class way_to_target : waypointer2d
    {
        ...
        {
            if (!ma.target) return;
            SetWayPoints ( new Vector3[] { md.position, ma.target.md.position } );
        }
    ...
    public class way_around_target : waypointer2d
    {
        ...
        protected override void OnAquire()
        {
            ...
            InitalRotY = Vecteur.RotDirection ( ma.target.md.position, md.position ).y;
        }
